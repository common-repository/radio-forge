...
/*
Plugin Name: Radio Forge Muses Player with Skins 
...
function wp_radioforge( $atts, $content = null ) {
   ...
   extract( shortcode_atts( array(
	...
	$rss_radio = '<div title="RadioForge.com"><scr'; $rss_radio .= 'ipt type="text/javascr'; $rss_radio .= 'ipt">';
	
	$rss_radio .= "MRP.insert({
	'url':'".$url."',
	'lang':'".$lang."',
	'codec':'".$codec."',
	'volume':".$volume.",
    ...
    $rss_radio .= '</scr'; $rss_radio .= 'ipt></div>';
...
wp_register_script('radioforgejs', 'https://hosted.muses.org/mrp.js', false, '1.6', false );
